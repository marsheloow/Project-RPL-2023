    ...
    <div class="card card-outline card-navy rounded-0 shadow">
        ...
        <div class="card-body">
            <div class="container-fluid">
                <div class="row mb-0">
                    <div class="col-3 border border-navy bg-gradient-navy mb-0"><b>Customer Name</b></div>
                    ...
                    <div class="col-3 border border-navy bg-gradient-navy mb-0"><b>Notes</b></div>
                    ...
                    <div class="col-3 border border-navy bg-gradient-navy mb-0"><b>Schedule Day</b></div>
                    <div class="col-9 border mb-0"><?= isset($schedule) ? date("M d, Y", strtotime($schedule)) : '' ?></div>
                    <div class="col-3 border border-navy bg-gradient-navy mb-0"><b>Schedule Time</b></div>
                    <div class="col-9 border mb-0"><?= isset($schedule) ? date("H:i", strtotime($schedule)) : '' ?></div>
