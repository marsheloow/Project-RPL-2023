    ...
    <form action="" id="update_status-form">
        ...
        <div class="form-group mb-3">
            ...
            <select name="status" id="status" class="form-control rounded-0">
                ...
                <option value="2" <?= isset($status) && $status == 2 ? "selected" : "" ?>>Arrived</option>
                <option value="3" <?= isset($status) && $status == 4 ? "selected" : "" ?>>Done</option>
                <option value="4" <?= isset($status) && $status == 5 ? "selected" : "" ?>>Cancelled</option>
            </select>
        </div>
    </form>
</div>
