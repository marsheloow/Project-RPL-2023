...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">List of Reservtions</h3>
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * FROM `reservation_list` order by unix_timestamp(date_updated) desc ");
					...
					?>
						<tr>
							...
							<td><p class="m-0 truncate-1"><?= date("M d, Y H:i", strtotime($row['schedule'])) ?></p></td>
							...
							<td align="center">
								<a class="btn btn-default bg-gradient-light btn-flat btn-sm" href="?page=reservations/view_details&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
