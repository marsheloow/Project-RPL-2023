...
<div class="container-fluid">
	<form action="" id="price-form">
		...
		<div class="row mx-0 w-100">
            <div class="px-2 py-1 col-5 border m-0 bg-navy bg-opacity-25 aling-middle text-center">Vehicle Type</div>
            <div class="px-2 py-1 col-7 border m-0 bg-navy bg-opacity-25 aling-middle text-center">Price</div>
            <?php 
            ...
            ?>
            <div class="px-2 py-1 col-5 border m-0 bg-navy bg-opacity-25 aling-middle"><?= $row['name'] ?></div>
